...
import com.neon.core.ui.infrastructure.RecompositionTracker
...
@Composable
fun <T : Draggable> NeoDraggableListLegacy(
    ...
    Box(
        ...
        Column(
            ...
            @Composable
            fun DraggableItemRow(index: Int, item: T) {
                    if (trackRecomposition) {
                        SideEffect { RecompositionTracker.increment() }
                    }
