...
object NeoFont {
    ...
    val display2 = TextStyle(fontFamily = Pretendard, fontWeight = FontWeight.Bold, fontSize = 80.sp)
    val display3 = TextStyle(fontFamily = Pretendard, fontWeight = FontWeight.Bold, fontSize = 72.sp)
    val display4 = TextStyle(fontFamily = Pretendard, fontWeight = FontWeight.Bold, fontSize = 48.sp)
    ...
    // Caption
    val caption1 = TextStyle(fontFamily = Pretendard, fontWeight = FontWeight.Normal, fontSize = 12.sp)
}
